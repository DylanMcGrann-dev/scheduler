...
storiesOf("Appointment", module)
  ...
  .add("Show", () => <Show interviewer={interviewers[0].name} student={"Lydia Miller-Jones"} onDelete={action("onDelete")} onEdit={action("onEdit")} />)
  ...
  .add("Form edit", () => <Form name={"mike"} interviewers={interviewers} interviewer={2} onSave={action("onSave")} onCancel={action("onCancel")} />)
